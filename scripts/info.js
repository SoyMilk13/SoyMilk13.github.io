...
new AlmanacPage('images/fruit-orange.png', 'Orange', '20%', '10', 'None', 'The orange was the first food added to Food Fighters.');
new AlmanacPage('images/fruit-watermelon.png', 'Watermelon', '20%', '10', 'None', 'Watermelons have the most rare variants, (as of now).');
new AlmanacPage('images/fruit-strawberry.png', 'Strawberry', '20%', '10', 'None', "Strawberries are the developer's favorite fruit!");
...
new AlmanacPage('images/fruit-bomb-almanac-image.png', 'Bomb', '25%', '10', "When clicked, the user is deducted one life. (Don't do this!)", "They have a cool animation... Although it's sad to say you've seen it.");
...
new AlmanacPage('images/vegetable-carrot.png', 'Carrot', '20%', '10', 'None', 'Fun fact: Carrots are roots.');
new AlmanacPage('images/vegetable-tomato.png', 'Tomato', '20%', '10', 'None', "There's a heated debate as to whether tomatos are actually vegetables or not.");